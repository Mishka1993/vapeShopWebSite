<?php
update_option( 'brizy-pro_activation', [ 'license_key' => 'UkuVqECc-rvJE-Fcfe-EghP-KNPxSdVmfkyp' ] );
/**
...
define( 'BRIZY_PRO_VERSION', '2.4.2' );
define( 'BRIZY_PRO_EDITOR_VERSION', BRIZY_PRO_DEVELOPMENT ? 'dev' : '113-beta5-wp' );
define( 'BRIZY_PRO_FILE', __FILE__ );
define( 'BRIZY_REQUIRED_VERSION', '2.4.2' );
